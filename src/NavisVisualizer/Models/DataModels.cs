...
namespace NavisVisualizer.Models
{
    ...
    public class ColorSetting
    {
        ...
        public static Dictionary<HydrotestStage, ColorSetting> HydrotestDefaults =>
            ...
            {
                [HydrotestStage.NotStarted]     = new ColorSetting { DisplayColor = Color.FromArgb(255, 0, 0), Transparency = 0.0 },
        ...
        public static Dictionary<SpoolStage, ColorSetting> SpoolDefaults =>
            ...
            {
                [SpoolStage.NotStarted]   = new ColorSetting { DisplayColor = Color.FromArgb(255, 0, 0), Transparency = 0.0  },
        ...
        public static Dictionary<EquipmentStage, ColorSetting> EquipmentDefaults =>
            ...
            {
                [EquipmentStage.NotStarted] = new ColorSetting { DisplayColor = Color.FromArgb(255, 0, 0), Transparency = 0.0 },
        ...
        public static Dictionary<EitStage, ColorSetting> EitDefaults =>
            ...
            {
                [EitStage.NotStarted] = new ColorSetting { DisplayColor = Color.FromArgb(255, 0, 0), Transparency = 0.0 },
        ...
        public static Dictionary<CableLineStage, ColorSetting> CableLineDefaults =>
            ...
            {
                [CableLineStage.NotStarted] = new ColorSetting { DisplayColor = Color.FromArgb(255, 0, 0), Transparency = 0.0 },
        ...
        public static Dictionary<ProgressStatus, ColorSetting> ProgressDefaults =>
            ...
            {
                [ProgressStatus.NotStarted] = new ColorSetting { DisplayColor = Color.FromArgb(255, 0, 0), Transparency = 0.0 },
        ...
        public static Dictionary<SubSystemStage, ColorSetting> SubSystemStageDefaults =>
            ...
            {
                [SubSystemStage.NotStarted] = new ColorSetting { DisplayColor = Color.FromArgb(255, 0, 0), Transparency = 0.0 },
